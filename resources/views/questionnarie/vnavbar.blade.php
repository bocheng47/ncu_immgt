        ...
        <ul id="myTab" class="nav nav-pills mb-3">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{ url('/enrollment/post') }}">公告</a></li>
                    <li><a href="{{ url('/enrollment/upload') }}">推甄資料上傳</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="{{ url('/enrollment/BS/BSothers') }}">其他入學招生</a></li>   
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="#d1" tabindex="-1" data-toggle="tab">考試入學</a></li>
                    <li><a href="#d2" tabindex="-1" data-toggle="tab">碩士在職專班學分班</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="#e1" tabindex="-1" data-toggle="tab">甄試入學</a></li>
                    <li><a href="#e2" tabindex="-1" data-toggle="tab">考試入學</a></li>
                </ul>
            </li>
