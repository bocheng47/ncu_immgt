...
<section class="container">
	<form action="{{ url('enrollment/BS/BSapply/storeText') }}" method="post">
		...
		<input type="text" name="year" class="form-control" placeholder="請輸入整數" style="ime-mode:disabled" onkeyup="return ValidateNumber(this,value)" required="required">
		<font face="monospace" size="5">招生名額</font>
		<input type="text" name="quota" class="form-control" placeholder="請輸入整數" style="ime-mode:disabled" onkeyup="return ValidateNumber(this,value)" required="required">
		...
		<input type="text" name="rate" class="form-control" required="required"><br>
