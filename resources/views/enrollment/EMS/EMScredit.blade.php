...
<!-- 主畫面 -->
	...
	<section class="container"><br>
    	...
    	<div class="col-sm-9"><br>
			...
			<div id="maincontent">
				@if($auth)
				<form method="post" action="{{ url('/enrollment/EMS/EMScredit') }}" enctype="multipart/form-data">
    				{{ csrf_field() }}
			    ...
			    @endif
			    @foreach($EMScredit as $pdf)
			    <embed class="view" src ="{{ asset('enrollmentpdf/emscredit/' . $pdf->pdf_name) }}"></embed>
			    @if($auth)
			    <form action="{{ url('/enrollment/EMS/EMScredit/'.$pdf->id) }}" method="post">
    			{{ csrf_field() }}
