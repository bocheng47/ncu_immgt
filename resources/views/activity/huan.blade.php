...
@section('css')
<!-- 放css -->
{{-- <link rel="stylesheet" href="{{ URL::asset('/css/huan.css') }}"> --}}
...
<!-- 主畫面 -->
  <div class="row">
    ...
    <div id = "back" style="text-align:right;"><a href="/activity" > &nbsp&nbsp首頁</a></div>
    <div class="huan-title" style="font-family:DFKai-sb;">&nbsp;{{ $activities->activityname }}</div>
    <div id="mid" style=" margin : 5px ; border : 0 ; padding : 0"></div>
 <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:960px;height:480px;overflow:hidden;visibility:hidden;background-color:#24262e;">
        <!-- Loading Screen -->
        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="{{ asset('js/activity/spin.svg') }}" />
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:240px;width:720px;height:480px;overflow:hidden;">
              @foreach($photoes as $photo)
                <div>
                   <img data-u="image" src="{{ asset('img/activity/'.$pid.'/'.$photo->pic) }}" / >
                   <img data-u="thumb" src="{{ asset('img/activity/'.$pid.'/'.$photo->pic) }}" / width="99px" height="66px">
                </div>
              @endforeach
        </div>
        <!-- Thumbnail Navigator -->
...
<div id="jssor_1" style="position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
    <div u="slides" style="position:absolute;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
        @foreach($photoes as $photo)
        <div>
           <img data-u="image" src="{{ asset('img/activity/'.$photo->pic) }}" / >
           <img data-u="thumb" src="{{ asset('img/activity/'.$photo->pic) }}" / width="99px" height="66px">
        </div>
        @endforeach
    </div>
</div>
        ...
        <!-- Arrow Navigator -->
        <div u="arrowleft" class="jssora093" style="width:50px;height:50px;top:0px;left:270px;" data-autocenter="2">
            <svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                <circle class="c" cx="8000" cy="8000" r="5920"></circle>
                <polyline class="a" points="7777.8,6080 5857.8,8000 7777.8,9920 "></polyline>
                <line class="a" x1="10142.2" y1="8000" x2="5857.8" y2="8000"></line>
        ...
        <div u="arrowright" class="jssora093" style="width:50px;height:50px;top:0px;right:30px;" data-autocenter="2">
            <svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                <circle class="c" cx="8000" cy="8000" r="5920"></circle>
                <polyline class="a" points="8222.2,6080 10142.2,8000 8222.2,9920 "></polyline>
                <line class="a" x1="5857.8" y1="8000" x2="10142.2" y2="8000"></line>
...
@section('js')
<!-- 放js -->
{{-- <link href="{{ asset('js/Magicslides.js') }}" rel="stylesheet"> --}}
{{-- <script type="text/javascript" src="{{ asset('js/activity/jssor.slider-27.5.0.min.js') }}"></script> --}}
